...
class HydrographyDiagram:
    ...
    def calculate_potential_density(self):
        ...
        """
        self.sa_list = [SA_from_SP(salinity, pressure, 39, 22) for salinity, pressure in zip(self.salinity_list, self.pressure_list)]
    ...
    def plot_diagram(self, save_dir, csv_files):
        ...
        for i, (data, csv_file) in enumerate(zip(self.data_list, csv_files)):
            ...
            scatter = ax.scatter(self.salinity_list[i], self.temperature_list[i], c=self.pressure_list[i],
                                 cmap='plasma_r', norm=norm, marker='o', s=20)
            ...
            contour = ax.contour(salinity_grid, temperature_grid, potential_density_grid, levels=[25.7, 26.8, 27.53],
                                 colors='black')
